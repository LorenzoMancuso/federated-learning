...
rsync -azv --append-verify --stats --human-readable --info=progress2 -e "ssh -i /home/lore/Scaricati/mancuso_federated" /media/lore/EA72A48772A459D9/ILSVRC2012/ILSVRC2012_img_train/subset02/ hpce17612@plogin1.bsc.es:/nvme1/imagenet/
