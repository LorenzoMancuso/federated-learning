...
rsync -azv -I --stats --human-readable --info=progress2 --exclude=".*" --exclude="res" --exclude="__pycache__" -e "ssh -o StrictHostKeyChecking=no -i /home/lore/Scaricati/mancuso_federated -J lmancuso@130.192.137.199" /home/lore/Projects/github/federated-learning/Server/ lmancuso@coordinator:/home/lmancuso/federated-learning/Server/
rsync -azv -I --stats --human-readable --info=progress2 --exclude=".*" --exclude="res" --exclude="__pycache__" -e "ssh -o StrictHostKeyChecking=no -i /home/lore/Scaricati/mancuso_federated -J lmancuso@130.192.137.199" /media/lore/B6C8D9F4C8D9B33B/Users/lorym/Downloads/IMAGENET/ILSVRC2012_devkit_t12 lmancuso@coordinator:/home/lmancuso/federated-learning/Server/res/